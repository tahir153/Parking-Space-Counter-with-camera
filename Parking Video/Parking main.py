...
cap = cv2.VideoCapture('parking_vid.mp4')
...
def CheckParkingSpace(imgPro):
    ...
    cvzone.putTextRect(img,f'{(spaceCounter)}/{len(Position_list)}',(6,90),scale=2.5,thickness=3,offset=5,
                       colorR=(77, 77, 78),colorT=(535, 545, 575)  )
# , colorR=(155,0,255)
while True:
